#pragma checksum "C:\Users\AdamG\source\repos\TestGroup\TestGroup\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "CAE4D7C0CDEC6520A4633C5602AEC744"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace TestGroup
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj7_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::TestGroup.Staff dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::TestGroup.Staff) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::TestGroup.Staff)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::TestGroup.Staff obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_getInfo(obj.getInfo, phase);
                    }
                }
            }
            private void Update_getInfo(global::System.String obj, int phase)
            {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::TestGroup.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::TestGroup.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::TestGroup.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_ViewModel(global::TestGroup.StaffViewModel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_ViewModel_Staffs(global::System.Collections.ObjectModel.ObservableCollection<global::TestGroup.Staff> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 5: // MainPage.xaml line 40
                {
                    this.UpadateView = (global::Windows.UI.Xaml.Controls.TextBlock)(target);
                }
                break;
            default:
                break;
